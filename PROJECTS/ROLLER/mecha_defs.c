 ...
 */
{
  ...
  .aWeapons = {
    ...
    [MECHA_SLOT_CENTER] = {
      [MECHA_STANCE_STAND] = { .szName = "CLUB SWING", .byKind = MECHA_PROJ_MELEE,
        .byMelee = MECHA_MELEE_CLUB,
      ...
      [MECHA_STANCE_GUARD] = { .szName = "CLUB RISE", .byKind = MECHA_PROJ_MELEE,
        .byMelee = MECHA_MELEE_CLUB,
        .byCount = 1, .byPalette = PAL_TRACER_WHITE,
      ...
      [MECHA_STANCE_DASH] = { .szName = "CLUB RUSH", .byKind = MECHA_PROJ_MELEE,
        .byMelee = MECHA_MELEE_CLUB,
        .byCount = 1, .byPalette = PAL_TRACER_WHITE,
        ...
        .fMuzzleHeight = 0.56f, .fMuzzleSide = 0.0f },
      [MECHA_STANCE_JUMP] = { .szName = "CLUB DROP", .byKind = MECHA_PROJ_MELEE,
        .byMelee = MECHA_MELEE_CLUB,
        .byCount = 1, .byPalette = PAL_TRACER_WHITE,
    ...
    [MECHA_SLOT_RIGHT] = {
      [MECHA_STANCE_STAND] = { .szName = "HORNET", .byKind = MECHA_PROJ_HOMING,
        ...
        .fMuzzleHeight = 0.70f, .fMuzzleSide = 1.0f },
      [MECHA_STANCE_GUARD] = { .szName = "HORNET NEST", .byKind = MECHA_PROJ_HOMING,
        ...
        .fMuzzleHeight = 0.60f, .fMuzzleSide = 1.0f },
      [MECHA_STANCE_DASH] = { .szName = "HORNET RUN", .byKind = MECHA_PROJ_HOMING,
        ...
        .fMuzzleHeight = 0.70f, .fMuzzleSide = 1.0f },
      [MECHA_STANCE_JUMP] = { .szName = "HORNET SWARM", .byKind = MECHA_PROJ_HOMING,
