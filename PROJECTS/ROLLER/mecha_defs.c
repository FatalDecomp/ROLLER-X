  ...
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      ...
      [MECHA_STANCE_JUMP] = { .szName = "AIRBURST", .byKind = MECHA_PROJ_BULLET,
        .byCount = 5, .byPalette = PAL_TRACER_AMBER, .iSpreadAngle = MECHA_DEG(7),
    ...
    [MECHA_SLOT_RIGHT] = {
      [MECHA_STANCE_STAND] = { .szName = "ROCKET POD", .byKind = MECHA_PROJ_HOMING,
        .byCount = 4, .byPalette = PAL_TRACER_AMBER, .iSpreadAngle = MECHA_DEG(11),
      ...
      [MECHA_STANCE_GUARD] = { .szName = "FULL SALVO", .byKind = MECHA_PROJ_HOMING,
        .byCount = 8, .byPalette = PAL_TRACER_AMBER, .iSpreadAngle = MECHA_DEG(14),
      ...
      [MECHA_STANCE_DASH] = { .szName = "SIDE BATTERY", .byKind = MECHA_PROJ_HOMING,
        .byCount = 3, .byPalette = PAL_TRACER_AMBER, .iSpreadAngle = MECHA_DEG(16),
 ...
 */
{
  ...
  .abyPalette = { PAL_HULL_DARK, PAL_HULL_DARK_T, PAL_JOINT, PAL_TRACER_GREEN },
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      [MECHA_STANCE_STAND] = { .szName = "SPINE REPEATER", .byKind = MECHA_PROJ_BULLET,
        .byCount = 3, .byPalette = PAL_TRACER_GREEN, .iSpreadAngle = MECHA_DEG(4),
      ...
      [MECHA_STANCE_GUARD] = { .szName = "SPINE AIMED", .byKind = MECHA_PROJ_BULLET,
        .byCount = 2, .byPalette = PAL_TRACER_GREEN, .iSpreadAngle = MECHA_DEG(1),
      ...
      [MECHA_STANCE_DASH] = { .szName = "SCUTTLE BURST", .byKind = MECHA_PROJ_BULLET,
        .byCount = 4, .byPalette = PAL_TRACER_GREEN, .iSpreadAngle = MECHA_DEG(8),
      ...
      [MECHA_STANCE_JUMP] = { .szName = "SPINE RAIN", .byKind = MECHA_PROJ_ARC,
        .byCount = 5, .byPalette = PAL_TRACER_GREEN, .iSpreadAngle = MECHA_DEG(7),
    ...
    [MECHA_SLOT_RIGHT] = {
      [MECHA_STANCE_STAND] = { .szName = "SNARE LINE", .byKind = MECHA_PROJ_MINE,
        .byCount = 2, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(22),
      ...
      [MECHA_STANCE_GUARD] = { .szName = "WEB", .byKind = MECHA_PROJ_MINE,
        .byCount = 5, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(30),
      ...
      [MECHA_STANCE_DASH] = { .szName = "TRAIL MINE", .byKind = MECHA_PROJ_MINE,
        .byCount = 2, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(10),
      ...
      [MECHA_STANCE_JUMP] = { .szName = "CEILING SPIKE", .byKind = MECHA_PROJ_ARC,
        .byCount = 3, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(8),
  ...
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      [MECHA_STANCE_STAND] = { .szName = "RIBBON", .byKind = MECHA_PROJ_BULLET,
        .byCount = 4, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(3),
      ...
      [MECHA_STANCE_DASH] = { .szName = "RIBBON SWEEP", .byKind = MECHA_PROJ_BULLET,
        .byCount = 5, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(7),
      ...
      [MECHA_STANCE_JUMP] = { .szName = "RIBBON FALL", .byKind = MECHA_PROJ_ARC,
        .byCount = 6, .byPalette = PAL_TRACER_VIOLET, .iSpreadAngle = MECHA_DEG(6),
